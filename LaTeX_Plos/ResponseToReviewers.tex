...
\commentPaul{Yes, perhaps, say less than about 1 micron  in the text.}
...
\blue{The ink leaves a pure silver film, so toxicity should not be different than elemental silver. The curing temperature is low and at this temperature, the silver is not oxidised during curing. The XRD characterization in Figure S2 shows the silver is not oxidized on the fabric after curing. \commentPaul{Perhaps add a statement in the text clarifying this point as well.}}
...
%is is not statistically true, even though the overall mean may be slightly less. The groups are not statistically different.}

...
\blue{The supplier has been added, as well as a better description of the materials and methods. The specific bleach is Giant Eagle brand and (Giant Eagle brand) has been added to the text. They only sell one. 
\commentPaul{Perhaps better description of this bleach.  Concentration level.  Sodium hypochlorite concentration level}
A better description of the other materials that were used have been changed in the Materials and Methods section. Sigma only sells one PBS and FBs. PDMS (Sylgard 184) has been added to the text. 

...
More recently, silver nanoparticles have been demonstrated to have antiviral properties against enveloped viruses such as severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2) and human immunodeficiency viruses (HIV) \cite{jeremiah_potent_2020,lara_2010,elechiguerra_interaction_2005,ahmed:2021}. %Silver nanoparticles may interact with viral nucleic acids to disrupt serial viral infection and replication.\cite{jeremiah_potent_2020}
%Silver nanoparticles have been incorporated 
%\commentPaul{Check and make sure citations are before punctuation.}
...
The combination of ultrasonic agitation and bleach not only mechanically removes silver from the textile, but also chemically reacts with silver. % to form silver chloride.  
...
%While the 
20 nm silver nanoparticle coating does not show HSV-1 inactivation with a $0.0 \pm 0.1$ log$_{10}$ difference, while the silver ink shows HSV-1 inactivation in saline by $1.6 \pm 0.9$ log$_{10}$ ($97.3 %\pm 5.5 
\%$) difference. 
%\commentPaul{Give percentage.}
...
%PDMS improves the liq the adhesion of the silver to the underlying microfibers by increasing the area of contact between the silver and textile as well as providing some chemical resistance.
...
PET is coated with PDMS only and washed to further investigate the structural integrity of the PDMS layer after bleach washing (\nameref{S3_Fig}). The static contact angle increases after bleach washing, confirming the roughening of the PDMS layer. No oxidation of the PDMS layer from bleach washing is observed using FTIR analysis, so the damage to the PDMS is believed to be primarily caused by cavitation during ultrasonic agitation. These findings suggest that some damage to the PDMS layer and the silver layer occurs from ultrasonic washing with bleach.   
...
Future work should analyze the antiviral mechanism, as well as the cytotoxicity of reactive silver ink treated fabrics before commercial use. %compared to silver nanoparticles of varying sizes on other virus strains. %The treatment is fluorine-free and utilizes cheap coal stocks for the potential of large scale production.
...
Virus Assays: Virus inactivation assays were performed by mixing silver nanoparticles or silver ink with  herpes virus in PBS at final silver concentration of 1 mg per mL (0.1\% v/v). Solutions were vortexed and incubated for 1 hour %while shaking for 60 minutes (Stoval Belly Dancer, level 7) 
...
Assays on Fabrics: Fabric samples were completely submerged in 0.4 mL of virus/PBS in Eppendorf tubes with moderate shaking for 1 hour (Stoval Belly Dancer, level 5) at room temperature. %Adenovirus/PBS inoculum titers were averaged as 1.6x105 and 1.4x104 PFU mL−1 for types 4 and 7a viruses, respec-tively. 
